...
VIRTUAL_WIDGET(DETECT SINK PIPELINE_ID, output, PIPELINE_ID)

#FIXME: platform data in pipeline
W_PIPELINE(N_DETECT(0), SCHEDULE_DEADLINE, SCHEDULE_PRIORITY, SCHEDULE_FRAMES, SCHEDULE_CORE, 1, pipe_media_schedule_plat)
