...
struct comp_dev *comp_new_ipc4(struct ipc4_module_init_instance *module_init)
{
	...
	if (drv->type == SOF_COMP_MODULE_ADAPTER) {
		...
		const struct ipc_config_process spec = {
			.data = (const unsigned char *)ipc->comp_data + sizeof(*module_init),
...
#if CONFIG_LIBRARY
		struct ipc *ipc = ipc_get();
		char *data = (char *)ipc->comp_data + sizeof(*module_init);
...
const struct ipc4_module_uuid uuid_map[] = {
	{0x6, {.a = 0x61bca9a8,	.b = 0x18d0, .c = 0x4a18,
	       .d = { 0x8e, 0x7b, 0x26, 0x39, 0x21, 0x98, 0x04, 0xb7 }}},
	{0x2, {.a = 0x39656eb2, .b = 0x3b71, .c = 0x4049,
	       .d = { 0x8d, 0x3f, 0xf9, 0x2c, 0xd5, 0xc4, 0x3c, 0x09 }}},
	{0x3, {.a = 0x3c56505a, .b = 0x24d7, .c = 0x418f,
		.d = { 0xbd, 0xdc, 0xc1, 0xf5, 0xa3, 0xac, 0x2a, 0xe0 }}},
